...
public class ChunkServerSendMinorHeartbeatToController implements Event {
	
	private final int type = Protocol.CHUNKSERVER_SEND_MINOR_HEARTBEAT_T0_CONTROLLER;
	...
	public ChunkServerSendMinorHeartbeatToController(byte[] marshalledBytes) throws IOException {
		...
		if (type != Protocol.CHUNKSERVER_SEND_MINOR_HEARTBEAT_T0_CONTROLLER) {
			System.out.println("Invalid Message Type for ChunkServerSendMinorHeartbeatToController");
			return;
		}
