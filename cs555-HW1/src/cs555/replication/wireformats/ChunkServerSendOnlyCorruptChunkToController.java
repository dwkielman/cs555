...
public class ChunkServerSendOnlyCorruptChunkToController implements Event {
	
	private final int type = Protocol.CHUNKSERVER_SEND_ONLY_CORRUPT_CHUNK_T0_CONTROLLER;
	...
	public ChunkServerSendOnlyCorruptChunkToController(byte[] marshalledBytes) throws IOException {
		...
		if (type != Protocol.CHUNKSERVER_SEND_ONLY_CORRUPT_CHUNK_T0_CONTROLLER) {
			System.out.println("Invalid Message Type for ChunkServerSendOnlyCorruptChunkToController");
			return;
		}
