...
public class ControllerForwardFixCorruptChunkToChunkServer implements Event {
	
	private final int type = Protocol.CONTROLLER_FORWARD_CORRUPT_CHUNK_TO_CHUNKSERVER;
	...
	public ControllerForwardFixCorruptChunkToChunkServer(byte[] marshalledBytes) throws IOException {
		...
		if (type != Protocol.CONTROLLER_FORWARD_CORRUPT_CHUNK_TO_CHUNKSERVER) {
			System.out.println("Invalid Message Type for ControllerForwardFixCorruptChunkToChunkServer");
			return;
		}
