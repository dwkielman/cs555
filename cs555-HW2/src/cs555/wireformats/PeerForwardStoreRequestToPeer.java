...
public class PeerForwardStoreRequestToPeer implements Event {

	private final int type = Protocol.PEER_FORWARD_STORE_REQUEST_TO_PEER;
	...
	public PeerForwardStoreRequestToPeer(String filename, String key, NodeInformation storeData, int numberOfTraces,
	 ...
	 * @throws IOException 
	 */
	public PeerForwardStoreRequestToPeer(byte[] marshalledBytes) throws IOException {
		ByteArrayInputStream baInputStream = new ByteArrayInputStream(marshalledBytes);
		DataInputStream din = new DataInputStream(new BufferedInputStream(baInputStream));
		
		int type = din.readInt();
		
		if (type != Protocol.PEER_FORWARD_STORE_REQUEST_TO_PEER) {
			System.out.println("Invalid Message Type for PeerForwardStoreRequestToPeer");
			return;
		}
