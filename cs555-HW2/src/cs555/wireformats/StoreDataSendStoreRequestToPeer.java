...
public class StoreDataSendStoreRequestToPeer implements Event {

	private final int type = Protocol.STOREDATA_SEND_STORE_REQUEST_TO_PEER;
	...
	public StoreDataSendStoreRequestToPeer(String filename, String key, NodeInformation storeData, int numberOfTraces,
	 ...
	 * @throws IOException 
	 */
	public StoreDataSendStoreRequestToPeer(byte[] marshalledBytes) throws IOException {
		ByteArrayInputStream baInputStream = new ByteArrayInputStream(marshalledBytes);
		DataInputStream din = new DataInputStream(new BufferedInputStream(baInputStream));
		
		int type = din.readInt();
		
		if (type != Protocol.STOREDATA_SEND_STORE_REQUEST_TO_PEER) {
			System.out.println("Invalid Message Type for StoreDataSendStoreRequestToPeer");
			return;
		}
