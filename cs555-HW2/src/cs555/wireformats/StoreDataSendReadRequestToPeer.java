...
public class StoreDataSendReadRequestToPeer implements Event {

	private final int type = Protocol.STOREDATA_SEND_READ_REQUEST_TO_PEER;
	...
	public StoreDataSendReadRequestToPeer(String filename, String key, NodeInformation storeData, int numberOfTraces,
	 ...
	 * @throws IOException 
	 */
	public StoreDataSendReadRequestToPeer(byte[] marshalledBytes) throws IOException {
		ByteArrayInputStream baInputStream = new ByteArrayInputStream(marshalledBytes);
		DataInputStream din = new DataInputStream(new BufferedInputStream(baInputStream));
		
		int type = din.readInt();
		
		if (type != Protocol.STOREDATA_SEND_READ_REQUEST_TO_PEER) {
			System.out.println("Invalid Message Type for StoreDataSendReadRequestToPeer");
			return;
		}
