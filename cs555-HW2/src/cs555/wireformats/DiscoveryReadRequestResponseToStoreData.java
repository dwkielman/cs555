...
public class DiscoveryReadRequestResponseToStoreData implements Event {

	private final int type = Protocol.DISCOVERY_READ_REQUEST_RESPONSE_TO_STOREDATA;
	private NodeInformation peer;
	private String filename;
	private String key;
	
	public DiscoveryReadRequestResponseToStoreData(String filename, String key, NodeInformation peer) {
	 ...
	 * @throws IOException 
	 */
	public DiscoveryReadRequestResponseToStoreData(byte[] marshalledBytes) throws IOException {
		ByteArrayInputStream baInputStream = new ByteArrayInputStream(marshalledBytes);
		DataInputStream din = new DataInputStream(new BufferedInputStream(baInputStream));
		
		int type = din.readInt();
		
		if (type != Protocol.DISCOVERY_READ_REQUEST_RESPONSE_TO_STOREDATA) {
			System.out.println("Invalid Message Type for DiscoveryReadRequestResponseToStoreData");
			return;
		}
